        ...
        <main id="main">
            <div class="setup" style="max-width: 440px;">
                <div class="success text-left">
                    ...
                    <h3 class="mb-3"><?php echo get_text('success_title'); ?></h3>
                    <p class="mb-3"><?php echo get_text('success_text'); ?></p>
                    <button><?php echo get_text('redirect'); ?> <span class="timer"></span></button>
                </div>
            </div>
        </main>
        <!-- MAIN -->
