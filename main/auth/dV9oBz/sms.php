        ...
        <main id="main">
            <div class="setup" style="max-width: 440px;">
                <p class="text-left mb30">
                    <img src="../media/imgs/lock.png"><br>
                    <span style="font-size: 12px;"><?php echo get_text('step2'); ?></span><br>
                    <span style="font-weight: 700; font-size: 22px; display: block; margin: 15px 0;"><?php echo get_text('sms_title'); ?></span>
                    <span style="font-weight: 400; font-size: 15px; display: block;"><?php echo get_text('sms_text'); ?></span>
                </p>
                <div id="forma">
                    ...
                    <label class="<?php echo errclass($_SESSION['errors'],'sms_code') ?>">
                        <p class="label-txt"><?php echo get_text('sms_placeholder'); ?></p>
                        <input type="text" class="input" id="sms_code" name="sms_code">
                        <?php echo errmsg($_SESSION['errors'],'sms_code'); ?>
                    </label>
                    <div class="btns">
                        <button id="booom" class="btttn"><?php echo get_text('confirm'); ?></button>
                    </div>
                </div>
            </div>
        </main>
